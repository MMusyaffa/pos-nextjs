    ...
    return(
        <>
            <div className="flex flex-col justify-between flex-grow bg-[#2d2d2d] p-4 rounded-md transition-all duration-500 delay-200 ease-in-out overflow-hidden">
                <a href="#" className={`flex flex-col ${cart.length ? 'opacity-100 translate-y-0 ' : 'opacity-0 -translate-y-10'} delay-200  space-y-4 duration-1000 transition-all text-sm `}>
